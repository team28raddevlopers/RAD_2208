            ...
            <table class="table table-hover text-center">
                ...
                <?php foreach($result as $row): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('Masseur/accept_booking/'.$row['booking_id'])?>" class="btn btn-success btn-sm">Accept </a></td>
                        <td><a href="<?php echo site_url('Masseur/cancel_booking/'.$row['booking_id'])?>" class="btn btn-danger btn-sm">Reject </a></td>
        ...
        <!-- <div class="modal" id="confirmAccept">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <a href="<?php echo site_url('Masseur/accept_booking/'.$row['booking_id'])?>" class="btn btn-success btn-sm">Accept Booking</a>
        ...
        <!-- <div class="modal" id="confirmReject">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                    <a href="<?php echo site_url('Maaseur/cancel_booking/'.$row['booking_id'])?>" class="btn btn-danger btn-sm">Reject Booking</a>
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
                    </div>
