        ...
        <?php if($result): ?>
                ...
                <?php foreach($result as $row): ?>
                      <tr>
                          ...
                          <!-- <td><button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirmCancel">Cancel</button></td> -->
                           <td><a href="<?php echo site_url('Masseur/cancel_booking/'.$row['booking_id'])?>" class="btn btn-danger btn-sm">Cancel Booking</a></td>
                      </tr>
                <?php endforeach; ?>
            </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <a href="<?php echo site_url('Masseur/cancel_booking/'.$row['booking_id'])?>" class="btn btn-danger btn-sm">Cancel Booking</a>
