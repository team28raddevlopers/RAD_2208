<div class="container">
        <br><br>
        <h1 class="display-4 text-center">Your Current Bookings</h1>
        <br><br>
        <?php if($result): ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo site_url('Masseur/cancel_booking/')?>" id="cancel-form" method="post" accept-charset="utf-8">
                            ...
                            <input type="hidden" id="form-action" value="<?php echo site_url('Masseur/cancel_booking/')?>">
                            ...
                            <input type="hidden" id="title" name="title" value="Masseur Booking Cancelled: Booking ID : ">
