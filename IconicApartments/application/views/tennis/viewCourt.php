<div class="container">
      <br><br>
      <h1 class="display-4 text-center">Your Current Tennis Court Bookings</h1>
           ...
           <div class="modal-dialog">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 ...
                 <form action="<?php echo site_url('Tennis/cancel_courtbooking/')?>" id="cancel-form" method="post" accept-charset="utf-8">
                   <input type="text" class="form-control" id="message" name="message" placeholder="Enter a short message for the admin(optional)">
                   <input type="hidden" id="form-action" value="<?php echo site_url('Tennis/cancel_courtbooking/')?>">
