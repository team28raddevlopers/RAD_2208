...
<html lang="en">
  ...
  <body>
        <nav class="navbar navbar-expand-md bg-dark navbar-dark justify-content-center sticky-top">
            ...
            <a class="navbar-brand" href="instructorHome.html">Gym</a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="currentBookings.html">Current Bookings</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pendingBookings.html">Pending Bookings</a>
                    </li> 
                </ul>
            </div>
