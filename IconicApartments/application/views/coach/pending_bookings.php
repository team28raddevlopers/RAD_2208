                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo site_url('Coach/accept_booking/')?>" id="accept-form" method="post" accept-charset="utf-8">
                                ...
                                <input type="hidden" id="form-action"  name="form-action" value="<?php echo site_url('Coach/accept_booking/')?>">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo site_url('Coach/reject_booking/')?>" id="reject-form" method="post" accept-charset="utf-8">
                                <input type="text" class="form-control" id="accept-message" name="accept-message" placeholder="Enter a short message for the resident(optional)">
