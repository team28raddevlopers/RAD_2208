<div class="container">
    <br><br>
    <h1 class="display-4 text-center">Book An Instructor To Help With Your Gym Session</h1>
    <br><hr><br>
 
    <!-- <div class="jumbotron"> -->
        <div class="row justify-content-center">
            <h3>Select Date and Time to Search Available Instructors</h3>
            <br><br><br>
    ...
    <?php if($available): ?>
        ...
        <?php else: ?>
            <h5 class="text-center">No Instructors Available At the Selected Time Slot. Please Select a Different Time Slot</h5>
        <?php endif; ?>
    <?php endif; ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="book" method="post" id="booking-form">
                    ...
                    <input type="text" class="form-control" id="message" name="message" placeholder="Enter a short message for the instructor(optional)">
