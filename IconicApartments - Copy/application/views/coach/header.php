...
<html lang="en">
  <head>
    ...
    <title>Iconic Appartments - Coach</title>
  </head>
  <body>
        <nav class="navbar navbar-expand-md bg-dark navbar-dark justify-content-center sticky-top">
                <!-- Brand -->
            <a class="navbar-brand" href="<?php echo site_url('coach')?>">Tennis Coach</a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?=($this->uri->segment(2)==='current_bookings')?'active':''?>" href="<?php echo site_url('coach/current_bookings')?>">Current Bookings</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?=($this->uri->segment(2)==='pending_bookings')?'active':''?>" href="<?php echo site_url('coach/pending_bookings')?>">Pending Bookings</a>
                    </li> 
                </ul>
