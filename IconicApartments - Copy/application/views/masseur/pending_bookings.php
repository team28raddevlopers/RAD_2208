                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo site_url('Masseur/accept_booking/')?>" id="accept-form" method="post" accept-charset="utf-8">
                                ...
                                <input type="hidden" id="form-action"  name="form-action" value="<?php echo site_url('Masseur/accept_booking/')?>">
                                ...
                                <input type="hidden" id="title" name="title" value="Masseur Booking Accepted: Booking ID : ">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo site_url('Masseur/reject_booking/')?>" id="reject-form" method="post" accept-charset="utf-8">
                                ...
                                <input type="hidden" id="title" name="title" value="Masseur Booking Rejected: Booking ID : ">
                                <input type="hidden" id="type" name="type" value="masseur_booking">
